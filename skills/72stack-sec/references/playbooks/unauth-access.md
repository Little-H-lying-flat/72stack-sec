...
| Critical | — | Roblox | [Subdomain Takeover to Authentication bypass](https://hackerone.com/reports/335330) | Vulnerability Type: Subdomain Takeover Description: Due to unclaimed or expired Hubspot instance an attacker is able to claim a… |
